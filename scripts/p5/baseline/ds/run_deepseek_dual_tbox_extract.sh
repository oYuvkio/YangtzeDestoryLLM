...
# Step 1: TBox S3 抽取
echo "[1/2] TBox S3 抽取..."
OUT_DIR_S3="outputs/eval_models_tbox_s3/deepseek-ai/DeepSeek-R1-Distill-Qwen-7B"
mkdir -p "$OUT_DIR_S3"
...
echo ""
echo "[2/2] TBox S2 抽取..."
OUT_DIR_S2="outputs/eval_models_tbox_s2/deepseek-ai/DeepSeek-R1-Distill-Qwen-7B"
mkdir -p "$OUT_DIR_S2"
