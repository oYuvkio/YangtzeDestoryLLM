#!/bin/bash
# Qwen/Qwen3-8B 双 TBox (S2/S3) 抽取脚本（仅抽取，不评测）
...
echo "=========================================="
echo "Qwen/Qwen3-8B 双 TBox 抽取（仅抽取，不评测）"
echo "=========================================="
echo ""

# Step 1: TBox S3 抽取
echo "[1/2] TBox S3 抽取..."
OUT_DIR_S3="outputs/eval_models_tbox_s3/Qwen/Qwen3-8B"
mkdir -p "$OUT_DIR_S3"
...
echo ""
echo "[2/2] TBox S2 抽取..."
OUT_DIR_S2="outputs/eval_models_tbox_s2/Qwen/Qwen3-8B"
mkdir -p "$OUT_DIR_S2"
